...
suspend fun <T : Event> CheckContext<T>.isModuleEnabled(module: Modules) {
    ...
    val logger = KotlinLogging.logger("io.github.jamalam.pinguino.util.Checks.moduleEnabled")
...
suspend fun <T : Event> CheckContext<T>.hasModeratorRole() {
    ...
    val logger = KotlinLogging.logger("io.github.jamalam.pinguino.util.Checks.hasModeratorRole")
    val guild = guildFor(event)
...
suspend fun <T : Event> CheckContext<T>.notExemptFromPhishing() {
    ...
    val logger = KotlinLogging.logger("io.github.jamalam.pinguino.util.Checks.notExemptFromPhishing")
    val guild = guildFor(event)
    val member = memberFor(event)
...
suspend fun <T : Event> CheckContext<T>.ownsThread() {
    ...
    val logger = KotlinLogging.logger("io.github.jamalam.pinguino.util.Checks.ownsThread")
    val guild = guildFor(event)
    val member = memberFor(event)
...
suspend fun <T : Event> CheckContext<T>.notInDm() {
    ...
    val logger = KotlinLogging.logger("io.github.jamalam.pinguino.util.Checks.notInDm")
    val guild = guildFor(event)
